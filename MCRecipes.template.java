package com.vitzli.${modname};

/** This is MCAddon recipe file, it !!CONTAINS!! bugs, check orphaned 'else's
    inside process.. methods and package and class name, it could (certainly will)
    be wrong.
*/
